  ...
  list: [
    {
      ...
      descriptions: [
        ...
        {
          content:
            '경영정보시스템(EIS) 시스템 유지보수 / 운영.',
          weight: 'MEDIUM',
          descriptions: [
            { content: '신규 사용자, 메뉴 권한 관리 및 운영'},
          ],
        },
        {
          content:
            'IT Support Center (ISC) 시스템 유지보수 / 운영.',
          weight: 'MEDIUM',
          descriptions: [
    ...
    },
    {
      ...
      descriptions: [
        {
          content:
            '그룹웨어 SSO 연동 로그인 기능 구현.',
        },
        {
          content:
            '보안감사에 활용 될 수 있도록 CTS 작성 기능 구현.',
          weight: 'MEDIUM',
          descriptions: [
            { content: '담당자 결제 기능으로 감사 자료 획득' },
          ],
        },
        {
          content:
            '담당자 결제, 건의 담당 팀장 결제할 수 있도록 구현.',
          weight: 'MEDIUM',
          descriptions: [
            { content: '결제간 알림 메일 전송 개발' },
          ],
        },
        {
          content:
            '대한전선 사내시스템 이용간 신속한 업무지원 가능하도록 설계 및 구현.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      descriptions: [
        {
          content:
            'ISO 15118 표준문서 분석 및 프로세스 설계'
        },
        {
          content:
            '전기차 충전 PnC 기능 BackEnd 기능 PKI 구현',
          weight: 'MEDIUM',
          descriptions: [
    ...
    },
    {
      ...
      descriptions: [
        ...
        {
          content:
            '브라우저 인증서 Javascript 로 설치가 필요없는 로그인 지원 개발 고도화',
        },
        {
          content:
            'PKCS#5, PKCS#7 등 표준 PKI 습득',
            weight: 'MEDIUM',
          descriptions: [
            { content: 'SEED, ARIA 등 국제 표준 암호화 알고리즘 이용 암복호화 개발' }
          ],
        },
        {
          content:
            'KCaseCrypto 라이브러리 담당 연구 및 분석',
        },
      ],
    },
    {
      ...
      descriptions: [
        ...
        {
          content: '(관련기사) 국방전산정보원, ㈜케이사인과 74억원 규모의 ‘국방획득정보시스템’ 체계개발 계약',
    ...
    },
    {
      ...
      descriptions: [
        {
          content:
            '네이버, 카카오지갑, 삼성패스, 페이코, 통신사패스 통합 간편 로그인 개발 담당',
            weight: 'MEDIUM',
          descriptions: [
    ...
    },
    {
      ...
      descriptions: [
        {
          content:
            'ORACLE 데이터 관리, 역량진단 시스템 개발, 통계 시스템 운영 관리'
        },
        {
          content:
            '창원대학교 이룸시스템 개발 참여'
    ...
    },
    {
      ...
      descriptions: [
        {
          content:
            '대학교 교과목 및 학점 연동, ORACLE, MSSQL 등 데이터베이스 데이터 관리'
        },
        {
          content:
            '부경대학교 디딤돌시스템 개발 참여'
