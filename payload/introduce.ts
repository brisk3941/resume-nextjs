...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    ...
    */
    '보안 기반 웹 시스템 개발과 인증 서비스 운영에 특화된 시스템 엔지니어입니다.',
    'PKI, SSO, 간편인증 API 등 실무 중심의 인증 시스템 개발/운영 경험을 다수 보유하고 있으며,',
    '공공기관·교육기관·대기업 등 다양한 환경에서 사용자 중심의 시스템 개선에 기여해왔습니다.',
    '개발과 운영을 연결하는 하이브리드형 엔지니어로, 실질적인 안정성과 효율을 제공합니다.'
  ],
  sign: 'Ju Myeong',
